...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
	...
	<xsl:template match="dri:document">
		<html class="no-js">
				...
				<xsl:otherwise>
					<div id="page">
						<div id="ds-main">
							...
							<div id="content">
								<div id="ds-content" class="container_16">
									<!--
			...
			/* <![CDATA[ */
			try {
				var piwikTracker=Piwik.getTracker("http://piwik.gwdg.de/piwik.php",123);
...
<!-- /Piwik -->
	...
	<xsl:template name="buildHead">
		<head>
			...
			<xsl:if test="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='feed'][@qualifier='atom+xml']">
				<link rel="alternate" title="GEO-LEO e-docs feeds">
					<xsl:attribute name="type">
						<xsl:text>application/</xsl:text>
						<xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='feed'][@qualifier='atom+xml']/@qualifier"/>
					</xsl:attribute>
					<xsl:attribute name="href">
						<xsl:value-of select="concat('http://goedoc-stage.sub.uni-goettingen.de', /dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='feed'][@qualifier='atom+xml'])"/>
		...
		<div id="foot">
			<div class="container_16">
				<div class="grid_16">
					...
					<div>
						<div id="bottommenu" class="grid_16">
							<h2 class="invisible">.</h2>
							<ul class="bottommenu">
								<li class="first"><a href="/impressum">Impressum</a></li>
								<li><a href="/about-us">Über Uns</a></li>
								<!--<li class="current"><a>Impressum und Kontakt</a></li>-->
								<!--<li><a href="nationallizenzen/">Nationallizenzen</a></li>
								...
								<li class="last">
									<a href="http://www.geo-leo.de" target="_blank">ViFa GEO-LEO</a>
								</li>  
								<!--<li class="last"><a href="hilfe/">Hilfe</a></li>-->
							</ul>
							<div class="clear">&#160;</div>
						</div>
					</div>
...
-->
	...
	<xsl:template name="addJavascript">
		...
		<!-- JavaScript for rotating frontpage menu (carousel) -->
		<!-- <script type="text/javascript">
				<xsl:attribute name="src">
					<xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='contextPath'][not(@qualifier)]"/>
					<xsl:text>/themes/</xsl:text>
					<xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='theme'][@qualifier='path']"/>
					<xsl:text>/lib/js/carousel.js</xsl:text>
				</xsl:attribute>&#160;
		</script> -->
		...
		<script type="text/javascript">
				<xsl:attribute name="src">
					...
					<xsl:text>/themes/</xsl:text>
					<xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='theme'][@qualifier='path']"/>
					<xsl:text>/lib/js/addon.js</xsl:text>
				</xsl:attribute>&#160;
		</script>
