...
<xsl:stylesheet 
    ...
    <xsl:template name="collectionDetailView-MODS">
        <div class="detail-view">
            ...
            <xsl:apply-templates select="./mets:dmdSec/mets:mdWrap[@MDTYPE='MODS']/mets:xmlData/mods:mods" mode="collectionDetailView-MODS"/>
    ...
    <xsl:template name="communityDetailView-MODS">
        <div class="detail-view">
            ...
            <xsl:apply-templates select="./mets:fileSec/mets:fileGrp[@USE='LOGO']"/>
            <!-- Generate the info about the collections from the metadata section -->
            <xsl:apply-templates select="./mets:dmdSec/mets:mdWrap[@MDTYPE='MODS']/mets:xmlData/mods:mods" mode="communityDetailView-MODS"/>
			<span class="hidden">&#160;</span>
        </div>
    </xsl:template>
